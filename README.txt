Installation Guide:
1) Copy the .apk file present in folder apk>release by the name app-release.apk on your android device
2) On your android device, nagvigate to this file and click
3) It will prompt for install, press install
